...
save(fam.sim, file = paste(getwd(), "/Frailty/Simulations/simdat_v2_hr.RData", sep = ""))
save(fam.sim.bc, file = paste(getwd(), "/Frailty/Simulations/simdat_bc_v2_hr.RData", sep = ""))
