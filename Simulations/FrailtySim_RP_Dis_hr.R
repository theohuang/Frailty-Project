...
load(paste(getwd(), "/Frailty/Simulations/simdat_bc_dis_hr.RData", sep = ""))
...
save(res.post, file = paste(getwd(), "/Frailty/Simulations/Family Frailty Distribution/High Risk/Dis/simfamdistdishr_", a1, ".RData", sep = ""))
...
save(res, file = paste(getwd(), "/Frailty/Simulations/Risk Predictions/High Risk/Dis/simresdishr_", a1, ".RData", sep = ""))
