...
load(paste(getwd(), "/Frailty/Simulations/simdat_bc_dis_cor.RData", sep = ""))
...
save(res.post, file = paste(getwd(), "/Frailty/Simulations/Family Frailty Distribution/Population/Dis/simfamdistdiscor_", a1, ".RData", sep = ""))
...
save(res, file = paste(getwd(), "/Frailty/Simulations/Risk Predictions/Population/Dis/simresdiscor_", a1, ".RData", sep = ""))
