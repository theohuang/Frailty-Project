...
load(paste(getwd(), "/Frailty/Simulations/simdat_v03_hr.RData", sep = ""))
...
save(res.post, file = paste(getwd(), "/Frailty/Simulations/Population Frailty Distribution/High Risk/Var03/simpopv03hr_", a1, ".RData", sep = ""))
