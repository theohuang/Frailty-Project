...
save(fam.sim, file = paste(getwd(), "/Frailty/Simulations/simdat_dis_hr.RData", sep = ""))
save(fam.sim.bc, file = paste(getwd(), "/Frailty/Simulations/simdat_bc_dis_hr.RData", sep = ""))
