...
load(paste(getwd(), "/Frailty/Simulations/simdat_dis_hr.RData", sep = ""))
...
save(res.post, file = paste(getwd(), "/Frailty/Simulations/Population Frailty Distribution/High Risk/Dis/simpopdishr_", a1, ".RData", sep = ""))
