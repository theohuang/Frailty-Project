...
## Using variance parameters of 2
## Net Risk
...
load(paste(getwd(), "/Frailty/Simulations/simdat_bc_v2_hr.RData", sep = ""))
...
save(res.post, file = paste(getwd(), "/Frailty/Simulations/Family Frailty Distribution/High Risk/Var2/simfamdistv2hr_", a1, ".RData", sep = ""))
...
save(res, file = paste(getwd(), "/Frailty/Simulations/Risk Predictions/High Risk/Var2/simresv2hr_", a1, ".RData", sep = ""))
