...
load(paste(getwd(), "/Frailty/Simulations/simdat_dis.RData", sep = ""))
...
save(res.post, file = paste(getwd(), "/Frailty/Simulations/Population Frailty Distribution/Dis/simpopdis_", a1, ".RData", sep = ""))
