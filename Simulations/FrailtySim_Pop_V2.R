...
load(paste(getwd(), "/Frailty/Simulations/simdat_v2.RData", sep = ""))
...
save(res.post, file = paste(getwd(), "/Frailty/Simulations/Population Frailty Distribution/Var2/simpopv2_", a1, ".RData", sep = ""))
