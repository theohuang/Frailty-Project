...
load(paste(getwd(), "/Frailty/Simulations/simdat_v03.RData", sep = ""))
...
save(res.post, file = paste(getwd(), "/Frailty/Simulations/Population Frailty Distribution/Var03/simpopv03_", a1, ".RData", sep = ""))
