...
save(res.post, file = paste(getwd(), "/Frailty/Simulations/Family Frailty Distribution/Var2/simfamdistv2_", a1, ".RData", sep = ""))
...
save(res, file = paste(getwd(), "/Frailty/Simulations/Risk Predictions/Var2/simresv2_", a1, ".RData", sep = ""))
