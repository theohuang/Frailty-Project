...
load(paste(getwd(), "/Frailty/Simulations/simdat_bc_v2.RData", sep = ""))
...
save(res.post, file = paste(getwd(), "/Frailty/Simulations/Family Frailty Distribution/Population/Var2/simfamdistv2_", a1, ".RData", sep = ""))
...
save(res, file = paste(getwd(), "/Frailty/Simulations/Risk Predictions/Population/Var2/simresv2_", a1, ".RData", sep = ""))
